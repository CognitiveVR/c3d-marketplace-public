...
Unreal sits between Unity and the code-only SDKs in shape. Like Unity it is editor-first, with in-engine tooling for scene and mesh upload. Unlike Unity it has two authoring surfaces, and several things Unity does automatically are opt-in here.
